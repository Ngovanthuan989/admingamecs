                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="/promotion/addPost" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="LJZnmuvRVPm1yD86tAKjhQ0d5rMhjRAZwlMgG9GE">
                            ...
                            <div class="form-group">
                                ...
                                <textarea
                                    style="background-color: rgb(42, 48, 56); color: rgb(255, 255, 255); width: 100%; visibility: hidden; display: none;"
                                    name="content" rows="10" id="my-editor"></textarea>
                                <div id="cke_my-editor"></div>
                            </div>
                            <div class="form-group">
                                <label for="subtitle">Nội dung Mobile</label><br>
                                <textarea
                                    style="background-color: rgb(42, 48, 56); color: rgb(255, 255, 255); width: 100%; visibility: hidden; display: none;"
                                    name="content_mb" rows="10" id="my-editor"></textarea>
                                <div id="cke_my-editor"></div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="time_start" id="datepicker"
                                    class="form-control hasDatepicker" required="">
                            </div>
                            <div class="form-group">
                                <label for="">Thời gian kết thúc</label>
                                <input type="text" name="time_end" id="datepicker1"
                                    class="form-control hasDatepicker" required="">
                            </div>
                            <div class="form-group">
